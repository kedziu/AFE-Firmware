...
public:
  ...
  /* Publishing MQTT Message. It calls private method publishToMQTTBroker. First
   * one publishes char string, second one float with optional specyfication
   * float format to convert string */
